...
const en = {
  ...
  settings: {
    ...
    darkMode: 'Dark Mode',
    chooseLanguage: 'Choose Language',
    chooseLanguageDesc: 'Select your preferred language for the interface',
    apply: 'Apply Changes',
    cancel: 'Cancel',
    languageUpdated: 'Language updated',
    languageUpdatedDesc: 'Language preference set to {{lang}}',
    darkOn: 'Dark mode enabled',
    darkOff: 'Dark mode disabled',
    darkOnDesc: 'Dark mode is now active',
    darkOffDesc: 'Dark mode has been disabled',
    aiOn: 'AI enabled',
    aiOff: 'AI disabled',
    aiOnDesc: 'AI features are now active',
    aiOffDesc: 'AI features have been disabled',
    historyCleared: 'History cleared',
    historyClearedDesc: 'All your notes have been deleted',
    failClear: 'Failed to clear history',
  },
  folders: {
    title: 'Folders',
    new: 'New',
    ...
    createdDesc: '"{{name}}" has been created',
    deleted: 'Folder deleted',
  },
  notesList: {
    loading: 'Loading notes...',
    empty: 'No study notes yet. Start by uploading your first learning material!',
    incompleteCount_one: '{{count}} incomplete note',
    incompleteCount_other: '{{count}} incomplete notes',
    cutOff: 'These notes were cut off during generation',
    continueAll: 'Continue All',
    continuingNote: 'Continuing note {{current}} of {{total}}',
    rateLimit: 'Please wait... Processing with rate limiting to avoid overload.',
    incomplete: 'Incomplete',
    continueBtn: 'Continue',
    continuingBtn: 'Continuing…',
    view: 'View',
    deleted: 'Note deleted successfully',
    renamed: 'Note renamed successfully',
    titleEmpty: 'Title cannot be empty',
    moved: 'Note moved to folder',
    movedAll: 'Note moved to all notes',
    bulkDone: 'Bulk Continue Complete',
    bulkDoneDesc: 'Completed: {{success}}, Still incomplete: {{fail}}',
    noIncomplete: 'No Incomplete Notes',
    noIncompleteDesc: 'All notes are already complete!',
    cannotContinue: 'Cannot Continue',
    cannotContinueDesc: 'This note has no saved source text to continue from.',
    notesCompleted: 'Notes Completed!',
    notesExtended: 'Notes Extended',
    notesCompletedDesc: 'This note is now complete.',
    notesExtendedDesc: 'Extended, but it may still be incomplete—run Continue again if needed.',
  },
  upload: {
    youtubeTitle: 'YouTube Transcription',
    youtubeDesc: 'Paste a YouTube URL to generate study notes',
    youtubeUrl: 'YouTube URL',
    youtubePh: 'https://youtube.com/watch?v=...',
    audioTitle: 'Audio/Video Upload',
    audioDesc: 'Upload MP3, MP4, or other media files',
    audioSelect: 'Select File (Max 20MB)',
    audioOver: 'File exceeds 20MB limit',
    audioSelected: 'Selected',
    pdfTitle: 'PDF Upload',
    pdfDesc: 'Upload PDF documents for analysis',
    pdfSelect: 'Select PDF',
    websiteTitle: 'Website Scraper',
    websiteDesc: 'Extract content from articles and web pages',
    websiteUrl: 'Website URL',
    websitePh: 'https://example.com/article',
    websiteHint: 'Works best with articles, Wikipedia pages, and public content. Does not work with login-required sites.',
    generate: 'Generate Notes',
    generating: 'Generating...',
    cancel: 'Cancel',
    cancelled: 'Cancelled',
    cancelledDesc: 'Processing was cancelled',
    success: 'Success!',
    youtubeOk: 'YouTube video transcribed and saved to your notes',
    audioOk: 'File transcribed and saved to your notes',
    pdfOk: 'PDF processed and saved to your notes',
    websiteOk: 'Website content saved to your notes',
    selectPdf: 'Please select a PDF file',
    selectFile: 'Please select a file',
    enterYoutube: 'Please enter a YouTube URL',
    enterWebsite: 'Please enter a website URL',
    incomplete: 'Notes generation was incomplete. Please try again.',
    failYt: 'Failed to process video',
    failAudio: 'Failed to process file',
    failPdf: 'Failed to process PDF',
    failWeb: 'Failed to process website',
  },
  loader: {
    ...
    moment: 'This is processing — not stuck. You can cancel anytime.',
    cancel: 'Cancel',
    percent: '{{p}}% complete',
...
const es = {
  ...
  settings: { title: 'Ajustes', changeLanguage: 'Cambiar Idioma', clearHistory: 'Borrar Historial', aiFeatures: 'Funciones IA', darkMode: 'Modo Oscuro', chooseLanguage: 'Elegir Idioma', chooseLanguageDesc: 'Selecciona tu idioma preferido', apply: 'Aplicar Cambios', cancel: 'Cancelar', languageUpdated: 'Idioma actualizado', languageUpdatedDesc: 'Idioma establecido en {{lang}}', darkOn: 'Modo oscuro activado', darkOff: 'Modo oscuro desactivado', darkOnDesc: 'El modo oscuro está activo', darkOffDesc: 'El modo oscuro fue desactivado', aiOn: 'IA activada', aiOff: 'IA desactivada', aiOnDesc: 'Las funciones de IA están activas', aiOffDesc: 'Las funciones de IA fueron desactivadas', historyCleared: 'Historial borrado', historyClearedDesc: 'Todas tus notas han sido eliminadas', failClear: 'Error al borrar el historial' },
  folders: { title: 'Carpetas', new: 'Nueva', create: 'Crear Nueva Carpeta', name: 'Nombre de carpeta', createBtn: 'Crear Carpeta', allNotes: 'Todas las Notas', created: 'Carpeta creada', createdDesc: '"{{name}}" ha sido creada', deleted: 'Carpeta eliminada' },
  notesList: { loading: 'Cargando notas...', empty: 'Aún no hay notas. ¡Sube tu primer material!', incompleteCount_one: '{{count}} nota incompleta', incompleteCount_other: '{{count}} notas incompletas', cutOff: 'Estas notas se cortaron durante la generación', continueAll: 'Continuar Todas', continuingNote: 'Continuando nota {{current}} de {{total}}', rateLimit: 'Por favor espera... procesando con límite de tasa.', incomplete: 'Incompleta', continueBtn: 'Continuar', continuingBtn: 'Continuando…', view: 'Ver', deleted: 'Nota eliminada correctamente', renamed: 'Nota renombrada', titleEmpty: 'El título no puede estar vacío', moved: 'Nota movida a la carpeta', movedAll: 'Nota movida a todas las notas', bulkDone: 'Continuación masiva completa', bulkDoneDesc: 'Completadas: {{success}}, Aún incompletas: {{fail}}', noIncomplete: 'No hay notas incompletas', noIncompleteDesc: '¡Todas las notas están completas!', cannotContinue: 'No se puede continuar', cannotContinueDesc: 'Esta nota no tiene texto fuente para continuar.', notesCompleted: '¡Notas completadas!', notesExtended: 'Notas extendidas', notesCompletedDesc: 'Esta nota ahora está completa.', notesExtendedDesc: 'Extendida, pero puede seguir incompleta.' },
  upload: { youtubeTitle: 'Transcripción de YouTube', youtubeDesc: 'Pega una URL de YouTube para generar notas', youtubeUrl: 'URL de YouTube', youtubePh: 'https://youtube.com/watch?v=...', audioTitle: 'Subir Audio/Video', audioDesc: 'Sube MP3, MP4 u otros archivos multimedia', audioSelect: 'Selecciona archivo (Máx 20MB)', audioOver: 'El archivo supera 20MB', audioSelected: 'Seleccionado', pdfTitle: 'Subir PDF', pdfDesc: 'Sube documentos PDF para análisis', pdfSelect: 'Selecciona PDF', websiteTitle: 'Extractor Web', websiteDesc: 'Extrae contenido de artículos y páginas web', websiteUrl: 'URL del sitio', websitePh: 'https://ejemplo.com/articulo', websiteHint: 'Funciona mejor con artículos y contenido público.', generate: 'Generar Notas', generating: 'Generando...', cancel: 'Cancelar', cancelled: 'Cancelado', cancelledDesc: 'El procesamiento fue cancelado', success: '¡Éxito!', youtubeOk: 'Video transcrito y guardado', audioOk: 'Archivo transcrito y guardado', pdfOk: 'PDF procesado y guardado', websiteOk: 'Contenido del sitio guardado', selectPdf: 'Selecciona un archivo PDF', selectFile: 'Selecciona un archivo', enterYoutube: 'Ingresa una URL de YouTube', enterWebsite: 'Ingresa una URL', incomplete: 'La generación fue incompleta. Inténtalo de nuevo.', failYt: 'Error al procesar el video', failAudio: 'Error al procesar el archivo', failPdf: 'Error al procesar el PDF', failWeb: 'Error al procesar el sitio' },
  loader: { extracting: 'Extrayendo contenido', analyzing: 'Analizando material', generating: 'Generando notas', creating: 'Creando materiales', fetchingTranscript: 'Obteniendo transcripción', transcribing: 'Transcribiendo audio', parsingPdf: 'Procesando PDF', scrapingWebsite: 'Leyendo sitio', callingAi: 'Llamando al modelo IA', saving: 'Guardando notas', moment: 'Está procesando — no está atascado. Puedes cancelar cuando quieras.', cancel: 'Cancelar', percent: '{{p}}% completado', activityLog: 'Registro' },
...
const fr = {
  ...
  settings: { title: 'Paramètres', changeLanguage: 'Changer la Langue', clearHistory: "Effacer l'Historique", aiFeatures: 'Fonctions IA', darkMode: 'Mode Sombre', chooseLanguage: 'Choisir la Langue', chooseLanguageDesc: 'Sélectionnez votre langue préférée', apply: 'Appliquer', cancel: 'Annuler', languageUpdated: 'Langue mise à jour', languageUpdatedDesc: 'Langue définie sur {{lang}}', darkOn: 'Mode sombre activé', darkOff: 'Mode sombre désactivé', darkOnDesc: 'Le mode sombre est actif', darkOffDesc: 'Le mode sombre est désactivé', aiOn: 'IA activée', aiOff: 'IA désactivée', aiOnDesc: 'Les fonctions IA sont actives', aiOffDesc: 'Les fonctions IA sont désactivées', historyCleared: 'Historique effacé', historyClearedDesc: 'Toutes vos notes ont été supprimées', failClear: "Échec de l'effacement" },
  folders: { title: 'Dossiers', new: 'Nouveau', create: 'Créer un Dossier', name: 'Nom du dossier', createBtn: 'Créer', allNotes: 'Toutes les Notes', created: 'Dossier créé', createdDesc: '"{{name}}" a été créé', deleted: 'Dossier supprimé' },
  notesList: { loading: 'Chargement des notes...', empty: "Aucune note. Téléversez votre premier matériel !", incompleteCount_one: '{{count}} note incomplète', incompleteCount_other: '{{count}} notes incomplètes', cutOff: 'Ces notes ont été coupées', continueAll: 'Tout Continuer', continuingNote: 'Note {{current}} sur {{total}}', rateLimit: 'Veuillez patienter... limitation de débit.', incomplete: 'Incomplète', continueBtn: 'Continuer', continuingBtn: 'En cours…', view: 'Voir', deleted: 'Note supprimée', renamed: 'Note renommée', titleEmpty: 'Le titre ne peut pas être vide', moved: 'Note déplacée', movedAll: 'Note déplacée vers toutes', bulkDone: 'Continuation terminée', bulkDoneDesc: 'Terminées: {{success}}, Restantes: {{fail}}', noIncomplete: 'Aucune note incomplète', noIncompleteDesc: 'Toutes les notes sont complètes !', cannotContinue: 'Impossible de continuer', cannotContinueDesc: 'Cette note n\'a pas de texte source.', notesCompleted: 'Notes terminées !', notesExtended: 'Notes étendues', notesCompletedDesc: 'Cette note est maintenant complète.', notesExtendedDesc: 'Étendue, mais peut être encore incomplète.' },
  upload: { youtubeTitle: 'Transcription YouTube', youtubeDesc: 'Collez une URL YouTube pour générer des notes', youtubeUrl: 'URL YouTube', youtubePh: 'https://youtube.com/watch?v=...', audioTitle: 'Téléverser Audio/Vidéo', audioDesc: 'MP3, MP4 ou autres médias', audioSelect: 'Sélectionner (Max 20 Mo)', audioOver: 'Le fichier dépasse 20 Mo', audioSelected: 'Sélectionné', pdfTitle: 'Téléverser PDF', pdfDesc: 'Téléversez des PDF à analyser', pdfSelect: 'Sélectionner PDF', websiteTitle: 'Extraction Web', websiteDesc: 'Extraire le contenu de pages web', websiteUrl: 'URL du site', websitePh: 'https://exemple.com/article', websiteHint: 'Fonctionne mieux avec articles et contenu public.', generate: 'Générer les Notes', generating: 'Génération...', cancel: 'Annuler', cancelled: 'Annulé', cancelledDesc: 'Traitement annulé', success: 'Succès !', youtubeOk: 'Vidéo transcrite et enregistrée', audioOk: 'Fichier transcrit et enregistré', pdfOk: 'PDF traité et enregistré', websiteOk: 'Contenu enregistré', selectPdf: 'Sélectionnez un PDF', selectFile: 'Sélectionnez un fichier', enterYoutube: 'Entrez une URL YouTube', enterWebsite: 'Entrez une URL', incomplete: 'Génération incomplète. Réessayez.', failYt: 'Échec de la vidéo', failAudio: 'Échec du fichier', failPdf: 'Échec du PDF', failWeb: 'Échec du site' },
  loader: { extracting: 'Extraction du contenu', analyzing: 'Analyse', generating: 'Génération des notes', creating: 'Création du matériel', fetchingTranscript: 'Récupération de la transcription', transcribing: 'Transcription', parsingPdf: 'Analyse du PDF', scrapingWebsite: 'Lecture du site', callingAi: 'Appel du modèle IA', saving: 'Enregistrement', moment: "C'est en traitement — pas bloqué. Vous pouvez annuler.", cancel: 'Annuler', percent: '{{p}}% terminé', activityLog: 'Journal' },
...
const zh = {
  ...
  settings: { title: '设置', changeLanguage: '更改语言', clearHistory: '清除历史', aiFeatures: 'AI 功能', darkMode: '深色模式', chooseLanguage: '选择语言', chooseLanguageDesc: '选择您偏好的界面语言', apply: '应用更改', cancel: '取消', languageUpdated: '语言已更新', languageUpdatedDesc: '语言已设为 {{lang}}', darkOn: '深色模式已启用', darkOff: '深色模式已禁用', darkOnDesc: '深色模式现已激活', darkOffDesc: '深色模式已禁用', aiOn: 'AI 已启用', aiOff: 'AI 已禁用', aiOnDesc: 'AI 功能现已激活', aiOffDesc: 'AI 功能已禁用', historyCleared: '历史已清除', historyClearedDesc: '所有笔记已删除', failClear: '清除历史失败' },
  folders: { title: '文件夹', new: '新建', create: '创建新文件夹', name: '文件夹名称', createBtn: '创建文件夹', allNotes: '所有笔记', created: '文件夹已创建', createdDesc: '"{{name}}" 已创建', deleted: '文件夹已删除' },
  notesList: { loading: '加载笔记中...', empty: '暂无学习笔记，开始上传您的第一个学习材料吧！', incompleteCount_one: '{{count}} 篇未完成笔记', incompleteCount_other: '{{count}} 篇未完成笔记', cutOff: '这些笔记在生成过程中被截断', continueAll: '全部继续', continuingNote: '正在继续第 {{current}} / {{total}} 篇', rateLimit: '请稍候…正在限流处理以避免过载。', incomplete: '未完成', continueBtn: '继续', continuingBtn: '继续中…', view: '查看', deleted: '笔记已成功删除', renamed: '笔记已重命名', titleEmpty: '标题不能为空', moved: '笔记已移到文件夹', movedAll: '笔记已移到全部', bulkDone: '批量继续完成', bulkDoneDesc: '已完成: {{success}}, 仍未完成: {{fail}}', noIncomplete: '没有未完成的笔记', noIncompleteDesc: '所有笔记都已完成！', cannotContinue: '无法继续', cannotContinueDesc: '此笔记没有可继续的源文本。', notesCompleted: '笔记已完成！', notesExtended: '笔记已扩展', notesCompletedDesc: '此笔记现已完成。', notesExtendedDesc: '已扩展，但可能仍未完成—如有需要请再次继续。' },
  upload: { youtubeTitle: 'YouTube 转录', youtubeDesc: '粘贴 YouTube 链接以生成学习笔记', youtubeUrl: 'YouTube 链接', youtubePh: 'https://youtube.com/watch?v=...', audioTitle: '音频/视频上传', audioDesc: '上传 MP3、MP4 或其他媒体文件', audioSelect: '选择文件（最大 20MB）', audioOver: '文件超过 20MB 限制', audioSelected: '已选择', pdfTitle: 'PDF 上传', pdfDesc: '上传 PDF 文档进行分析', pdfSelect: '选择 PDF', websiteTitle: '网站抓取', websiteDesc: '从文章和网页中提取内容', websiteUrl: '网址', websitePh: 'https://example.com/article', websiteHint: '最适合文章、维基百科等公开内容。需登录的网站不支持。', generate: '生成笔记', generating: '生成中...', cancel: '取消', cancelled: '已取消', cancelledDesc: '处理已取消', success: '成功！', youtubeOk: 'YouTube 视频已转录并保存', audioOk: '文件已转录并保存', pdfOk: 'PDF 已处理并保存', websiteOk: '网站内容已保存到笔记', selectPdf: '请选择 PDF 文件', selectFile: '请选择文件', enterYoutube: '请输入 YouTube 链接', enterWebsite: '请输入网址', incomplete: '笔记生成不完整，请重试。', failYt: '处理视频失败', failAudio: '处理文件失败', failPdf: '处理 PDF 失败', failWeb: '处理网站失败' },
  loader: { extracting: '提取内容中', analyzing: '分析材料中', generating: '生成笔记中', creating: '创建学习材料中', fetchingTranscript: '获取转录中', transcribing: '转录音频中', parsingPdf: '解析 PDF 中', scrapingWebsite: '抓取网站中', callingAi: '调用 AI 模型中', saving: '保存到您的笔记', moment: '正在处理 — 没有卡住。可以随时取消。', cancel: '取消', percent: '完成 {{p}}%', activityLog: '活动日志' },
...
const ja = {
  ...
  settings: { title: '設定', changeLanguage: '言語を変更', clearHistory: '履歴をクリア', aiFeatures: 'AI 機能', darkMode: 'ダークモード', chooseLanguage: '言語を選択', chooseLanguageDesc: 'お好みの言語を選択', apply: '適用', cancel: 'キャンセル', languageUpdated: '言語を更新しました', languageUpdatedDesc: '言語を {{lang}} に設定', darkOn: 'ダークモード有効', darkOff: 'ダークモード無効', darkOnDesc: 'ダークモードが有効です', darkOffDesc: 'ダークモードが無効です', aiOn: 'AI 有効', aiOff: 'AI 無効', aiOnDesc: 'AI 機能が有効です', aiOffDesc: 'AI 機能が無効です', historyCleared: '履歴をクリアしました', historyClearedDesc: 'すべてのノートを削除しました', failClear: '履歴クリアに失敗' },
  folders: { title: 'フォルダ', new: '新規', create: '新しいフォルダを作成', name: 'フォルダ名', createBtn: '作成', allNotes: 'すべてのノート', created: 'フォルダ作成', createdDesc: '"{{name}}" を作成しました', deleted: 'フォルダを削除' },
  notesList: { loading: 'ノート読み込み中...', empty: 'まだノートがありません。最初の学習資料をアップロードしましょう！', incompleteCount_one: '未完了 {{count}} 件', incompleteCount_other: '未完了 {{count}} 件', cutOff: 'これらのノートは途中で切れました', continueAll: 'すべて続行', continuingNote: '{{current}} / {{total}} 件目を続行中', rateLimit: 'お待ちください…レート制限付きで処理中。', incomplete: '未完了', continueBtn: '続行', continuingBtn: '続行中…', view: '表示', deleted: 'ノートを削除しました', renamed: 'ノート名を変更', titleEmpty: 'タイトルは空にできません', moved: 'フォルダに移動', movedAll: 'すべてのノートに移動', bulkDone: '一括続行完了', bulkDoneDesc: '完了: {{success}} 件, 未完了: {{fail}} 件', noIncomplete: '未完了ノートなし', noIncompleteDesc: 'すべてのノートが完了済みです！', cannotContinue: '続行できません', cannotContinueDesc: '続行用のソーステキストがありません。', notesCompleted: 'ノート完了！', notesExtended: 'ノートを拡張', notesCompletedDesc: 'このノートは完了しました。', notesExtendedDesc: '拡張しましたが、まだ未完了の可能性があります。' },
  upload: { youtubeTitle: 'YouTube 文字起こし', youtubeDesc: 'YouTube の URL を貼り付けてノート生成', youtubeUrl: 'YouTube URL', youtubePh: 'https://youtube.com/watch?v=...', audioTitle: '音声/動画アップロード', audioDesc: 'MP3、MP4 などをアップロード', audioSelect: 'ファイル選択（最大 20MB）', audioOver: 'ファイルが 20MB を超えています', audioSelected: '選択中', pdfTitle: 'PDF アップロード', pdfDesc: 'PDF を解析用にアップロード', pdfSelect: 'PDF を選択', websiteTitle: 'ウェブサイト抽出', websiteDesc: '記事やページからコンテンツ抽出', websiteUrl: 'ウェブサイト URL', websitePh: 'https://example.com/article', websiteHint: '記事や Wikipedia など公開コンテンツに最適。', generate: 'ノートを生成', generating: '生成中...', cancel: 'キャンセル', cancelled: 'キャンセルしました', cancelledDesc: '処理をキャンセルしました', success: '成功！', youtubeOk: '動画を文字起こしし保存しました', audioOk: 'ファイルを文字起こしし保存', pdfOk: 'PDF を処理し保存', websiteOk: 'サイトの内容を保存', selectPdf: 'PDF を選択してください', selectFile: 'ファイルを選択してください', enterYoutube: 'YouTube URL を入力', enterWebsite: 'URL を入力', incomplete: 'ノート生成が未完了です。再試行してください。', failYt: '動画処理に失敗', failAudio: 'ファイル処理に失敗', failPdf: 'PDF 処理に失敗', failWeb: 'サイト処理に失敗' },
  loader: { extracting: 'コンテンツ抽出中', analyzing: '解析中', generating: 'ノート生成中', creating: '学習教材作成中', fetchingTranscript: '文字起こし取得中', transcribing: '音声文字起こし中', parsingPdf: 'PDF 解析中', scrapingWebsite: 'サイト読込中', callingAi: 'AI モデル呼び出し中', saving: 'ノートに保存中', moment: '処理中です — 止まっていません。いつでもキャンセル可能。', cancel: 'キャンセル', percent: '{{p}}% 完了', activityLog: 'アクティビティログ' },
...
const ms = {
  ...
  settings: { title: 'Tetapan', changeLanguage: 'Tukar Bahasa', clearHistory: 'Padam Sejarah', aiFeatures: 'Ciri AI', darkMode: 'Mod Gelap', chooseLanguage: 'Pilih Bahasa', chooseLanguageDesc: 'Pilih bahasa pilihan anda', apply: 'Sahkan', cancel: 'Batal', languageUpdated: 'Bahasa dikemas kini', languageUpdatedDesc: 'Bahasa ditetapkan ke {{lang}}', darkOn: 'Mod gelap dihidupkan', darkOff: 'Mod gelap dimatikan', darkOnDesc: 'Mod gelap kini aktif', darkOffDesc: 'Mod gelap dimatikan', aiOn: 'AI dihidupkan', aiOff: 'AI dimatikan', aiOnDesc: 'Ciri AI kini aktif', aiOffDesc: 'Ciri AI dimatikan', historyCleared: 'Sejarah dipadam', historyClearedDesc: 'Semua nota telah dipadam', failClear: 'Gagal padam sejarah' },
  folders: { title: 'Folder', new: 'Baharu', create: 'Cipta Folder Baharu', name: 'Nama folder', createBtn: 'Cipta', allNotes: 'Semua Nota', created: 'Folder dicipta', createdDesc: '"{{name}}" telah dicipta', deleted: 'Folder dipadam' },
  notesList: { loading: 'Memuat nota...', empty: 'Belum ada nota. Muat naik bahan pembelajaran pertama anda!', incompleteCount_one: '{{count}} nota tidak lengkap', incompleteCount_other: '{{count}} nota tidak lengkap', cutOff: 'Nota ini terpotong semasa penjanaan', continueAll: 'Sambung Semua', continuingNote: 'Menyambung nota {{current}} / {{total}}', rateLimit: 'Sila tunggu... pemprosesan dengan had kadar.', incomplete: 'Tidak Lengkap', continueBtn: 'Sambung', continuingBtn: 'Menyambung…', view: 'Lihat', deleted: 'Nota dipadam', renamed: 'Nota dinamakan semula', titleEmpty: 'Tajuk tidak boleh kosong', moved: 'Nota dipindah ke folder', movedAll: 'Nota dipindah ke semua', bulkDone: 'Sambungan pukal selesai', bulkDoneDesc: 'Selesai: {{success}}, Tidak lengkap: {{fail}}', noIncomplete: 'Tiada nota tidak lengkap', noIncompleteDesc: 'Semua nota telah lengkap!', cannotContinue: 'Tidak boleh sambung', cannotContinueDesc: 'Nota ini tiada teks sumber.', notesCompleted: 'Nota lengkap!', notesExtended: 'Nota diperluas', notesCompletedDesc: 'Nota ini kini lengkap.', notesExtendedDesc: 'Diperluas, mungkin masih tidak lengkap.' },
  upload: { youtubeTitle: 'Transkripsi YouTube', youtubeDesc: 'Tampal URL YouTube untuk jana nota', youtubeUrl: 'URL YouTube', youtubePh: 'https://youtube.com/watch?v=...', audioTitle: 'Muat Naik Audio/Video', audioDesc: 'Muat naik MP3, MP4 atau media lain', audioSelect: 'Pilih Fail (Maks 20MB)', audioOver: 'Fail melebihi 20MB', audioSelected: 'Dipilih', pdfTitle: 'Muat Naik PDF', pdfDesc: 'Muat naik dokumen PDF untuk analisis', pdfSelect: 'Pilih PDF', websiteTitle: 'Pengikis Laman Web', websiteDesc: 'Ekstrak kandungan dari laman web', websiteUrl: 'URL laman web', websitePh: 'https://contoh.com/artikel', websiteHint: 'Paling sesuai untuk artikel dan kandungan awam.', generate: 'Jana Nota', generating: 'Menjana...', cancel: 'Batal', cancelled: 'Dibatalkan', cancelledDesc: 'Pemprosesan dibatalkan', success: 'Berjaya!', youtubeOk: 'Video YouTube ditranskripsi dan disimpan', audioOk: 'Fail ditranskripsi dan disimpan', pdfOk: 'PDF diproses dan disimpan', websiteOk: 'Kandungan laman web disimpan', selectPdf: 'Sila pilih fail PDF', selectFile: 'Sila pilih fail', enterYoutube: 'Sila masukkan URL YouTube', enterWebsite: 'Sila masukkan URL', incomplete: 'Penjanaan tidak lengkap. Sila cuba lagi.', failYt: 'Gagal proses video', failAudio: 'Gagal proses fail', failPdf: 'Gagal proses PDF', failWeb: 'Gagal proses laman web' },
  loader: { extracting: 'Mengekstrak kandungan', analyzing: 'Menganalisis bahan', generating: 'Menjana nota', creating: 'Mencipta bahan belajar', fetchingTranscript: 'Mengambil transkripsi', transcribing: 'Mentranskripsi audio', parsingPdf: 'Menghurai PDF', scrapingWebsite: 'Membaca laman web', callingAi: 'Memanggil model AI', saving: 'Menyimpan nota', moment: 'Sedang diproses — bukan tergantung. Anda boleh batal bila-bila.', cancel: 'Batal', percent: '{{p}}% selesai', activityLog: 'Log aktiviti' },
